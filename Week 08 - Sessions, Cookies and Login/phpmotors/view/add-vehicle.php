			...
			<form id="vehicles" method="post" action="/phpmotors/vehicles/index.php">
				...
				<fieldset>
					...
					<div>
						...
						<input type="text" id="image_id" name="invImage" value="/images/no-image.jpg" required <?php if (isset($invImage)) {
																													echo "value='$invImage'";
																												}  ?>>
					</div>
					<div>
						<label for="thumbnail_id">Thumbnail Path * </label><br />
						<input type="text" id="thumbnail_id" name="invThumbnail" value="/images/no-image-tn.jpg" required <?php if (isset($invThumbnail)) {
