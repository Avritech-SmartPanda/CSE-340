 <?php
  ...
  switch ($action) {
    ...
    case 'login':
      ...
      $first = substr($clientData['clientFirstname'], 0, 1);
      ...
      setcookie('displayName', $screenName, strtotime('+1 year'), '/');


      $reviewList = getClientReviews($clientData['clientId']);
    ...
    case 'logout':
      if (isset($_COOKIE['firstname'])) {
        ...
        setcookie('displayName', '', strtotime('-1 year'), '/');
      }
      session_unset();
      session_destroy();
